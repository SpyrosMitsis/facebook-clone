...
const FriendRequest = (props: Props) => {
    ...
    const ADD_FRIEND = `/Friend/addFriend/${props.userId}?friendId=${props.friendId}`;
            ...
            <div className="signup">
                <div className="signup-container">
                    <div className="signup-header">
                        <div>
                            <h2>Do you really want to send friend request to {props.friendFirstName} {props.friendLastName}?</h2>
                        </div>
